			...
			>
				...
				<ul class="flex gap-4 sm:gap-8">
					<a
						...
						:href="social.url"
						target="__blank"
						class="text-gray-400 hover:text-emerald-500 dark:hover:text-emerald-400 cursor-pointer rounded-lg bg-gray-50 dark:bg-ternary-dark hover:bg-gray-100 shadow-sm p-4 duration-500"
					>
						<i
